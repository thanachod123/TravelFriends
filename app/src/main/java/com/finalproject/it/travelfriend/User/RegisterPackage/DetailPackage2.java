...
public class DetailPackage2 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_package2);
        ...
        toolbar.setTitleTextAppearance(DetailPackage2.this, R.style.FontForActionBar);
            ...
            protected void onBindViewHolder(@NonNull final ViewHolderPackageUserReview holder, int position, @NonNull ReviewData model) {
                ...
                mReferenceGuide.child(touristId).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Picasso.with(DetailPackage2.this).load(strProfileImage).placeholder(R.drawable.default_profile).into(holder.circleImageView);
                    }
        ...
        recyclerReview.setLayoutManager(new LinearLayoutManager(DetailPackage2.this));
        ...
        mReferencePackage.child(packageID)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Picasso.with(DetailPackage2.this).load(strImage).placeholder(R.drawable.package_image).into(img_package);
                        mReferenceGuide.child(guideID)
                                .addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        Picasso.with(DetailPackage2.this).load(strProfile_image).placeholder(R.drawable.package_image).into(img_guide_image);
