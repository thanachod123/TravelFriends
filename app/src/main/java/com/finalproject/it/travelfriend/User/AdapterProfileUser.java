...
public class AdapterProfileUser extends BaseAdapter {
    Context mContext;
    String[] profileMenu;
    int[] resId;

    public AdapterProfileUser(Context mContext, String[] profileMenu, int[] resId) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null)
            view = mInflater.inflate(R.layout.listview_profile_user, viewGroup,false);
