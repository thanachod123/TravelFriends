...
public class Culture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerCulture = findViewById(R.id.recyclerCulture);

        floatingSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Culture.this, SearchActivity.class));
            }

        });

        options = new FirebaseRecyclerOptions.Builder<PackageData>()
                .setQuery(mReferencePackage.orderByChild("status_type").equalTo("ตรวจสอบแล้ว_ท่องเที่ยวทางวัฒนธรรม"),PackageData.class).build();
        packageAdapter = new FirebaseRecyclerAdapter<PackageData, ViewHolderPackageUser>(options) {
            ...
            protected void onBindViewHolder(@NonNull final ViewHolderPackageUser holder, final int position, @NonNull PackageData model) {
                ...
                if (model.getVehicle_type().equals("Car")){
                    Picasso.with(Culture.this).load(R.drawable.car)
                            .into(holder.img_vehicle_type);
                } else if (model.getVehicle_type().equals("Motorcycle")){
                    Picasso.with(Culture.this).load(R.drawable.scooter)
                            .into(holder.img_vehicle_type);
                }else if (model.getVehicle_type().equals("Van")){
                    Picasso.with(Culture.this).load(R.drawable.van)
                            .into(holder.img_vehicle_type);
                }else if (model.getVehicle_type().equals("Jetski")){
                    Picasso.with(Culture.this).load(R.drawable.jetboating)
                            .into(holder.img_vehicle_type);
                }else {
                    Picasso.with(Culture.this).load(R.drawable.car)
                            .into(holder.img_vehicle_type);
                }
                Picasso.with(Culture.this).load(model.getImage()).placeholder(R.drawable.package_image).into(holder.imgPackage);
                ...
                mReferenceGuide.child(guideId).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Picasso.with(Culture.this).load(guideImage).placeholder(R.drawable.default_profile).into(holder.imgGuide);
                    }
                        ...
                        mReferenceGuide.child(touristId).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if ("".equalsIgnoreCase(strTouristName) | "".equalsIgnoreCase(strTouristSurname) | "".equalsIgnoreCase(strProvince) | "".equalsIgnoreCase(strProfile_image) | "".equalsIgnoreCase(strPhone) | "".equalsIgnoreCase(strDistrict) | "".equalsIgnoreCase(strCitizen_image)){
                                    ...
                                    Intent intentEditPackage = new Intent(Culture.this,DetailPackage.class);
        ...
        recyclerCulture.setLayoutManager(new LinearLayoutManager(Culture.this));
        packageAdapter.startListening();
        recyclerCulture.setAdapter(packageAdapter);
    ...
    private void setupDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentEditUser = new Intent(Culture.this,EditProfileUser.class);
